            ...
            modelBuilder.Entity("Ventagram.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("AllowsSiteChat")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("Ventagram.Models.Publication", b =>
                {
                    ...
                    b.Property<DateTime?>("ExpirationNoticeSentAtUtc")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<DateTime?>("ReportTrashSentAtUtc")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime?>("ReportWarningSentAtUtc")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("Ventagram.Models.PublicationReport", b =>
                {
                    ...
                    b.Property<bool>("CountsTowardThreshold")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.HasIndex("PublicationId", "ReporterUserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Ventagram.Models.PublicationReport", b =>
                {
                    ...
                    b.HasOne("Ventagram.Models.ApplicationUser", "ReporterUser")
                        .WithMany("Reports")
                        .HasForeignKey("ReporterUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Ventagram.Models.ApplicationUser", "ReviewedByUser")
                        .WithMany()
